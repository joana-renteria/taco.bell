...
public class VDatos extends JDialog implements ActionListener {
	...
	public VDatos(JDialog VMenuCliente, Usuarie pUsuarie) {
		...
		panelNombre.setBounds(30, 151, 241, 44);
		...
		panelApellido.add(separatorApellido);

		JPanel panelCorreo = new JPanel();
		panelCorreo.setFont(new Font("Iosevka Aile Heavy", Font.PLAIN, 32));
		panelCorreo.setBounds(30, 400, 241, 44);
		...
		panelCorreo.add(separatorCorreo);

		JPanel panelContra1 = new JPanel();
		panelContra1.setFont(new Font("Iosevka Aile Heavy", Font.PLAIN, 32));
		panelContra1.setBounds(464, 151, 237, 44);
		panelProductos.add(panelContra1);
		panelContra1.setLayout(new BoxLayout(panelContra1, BoxLayout.Y_AXIS));
		...
		JSeparator separatorContra1 = new JSeparator();
		panelContra1.add(separatorContra1);

		JPanel panelContra2 = new JPanel();
		panelContra2.setFont(new Font("Iosevka Aile Heavy", Font.PLAIN, 32));
		panelContra2.setBounds(464, 276, 237, 44);
		panelProductos.add(panelContra2);
		panelContra2.setLayout(new BoxLayout(panelContra2, BoxLayout.Y_AXIS));
		...
		JSeparator separatorContra2 = new JSeparator();
		panelContra2.add(separatorContra2);
		...
		listaDatos.setFont(new Font("Iosevka Aile Heavy", Font.BOLD, 26));
		listaDatos.setFocusable(false);
